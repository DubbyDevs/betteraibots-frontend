...
<body>
    ...
    <footer>
        <div class="footer-content">
            <img src="https://betteraibots.com/betteraibotsglowlogo8.png" alt="BetterAiBots Logo" class="footer-logo" />
            <span class="footer-text">Powered by DubbyDevs</span>
        </div>
        <div class="footer-copyright">
            ©2025 BetterAiBots.com | Legal, Terms & Privacy
        </div>
    </footer>
