// Netlify Function for handling news article social media previews
exports.handler = async (event, context) => {
  ...
  // Extract the article slug from the path
  const path = event.path;
  const articleSlug = path.split('/news/')[1];

  // News articles data
  const newsArticles = {
    "trump-ai-action-plan-global-leadership": {
    ...
    "china-global-ai-cooperation-organization": {
    ...
    "openai-gpt5-revolutionary-multimodal-ai": {
    ...
    "google-gemini-pro-100-million-users": {
    ...
    "microsoft-copilot-pro-productivity": {
    ...
    "anthropic-claude-35-sonnet-reasoning": {
  ...
  // If it's a social media crawler and we have the article data
  if (isSocialMediaCrawler && newsArticles[articleSlug]) {
    const article = newsArticles[articleSlug];
...
<head>
    ...
    <!-- Open Graph -->
    <meta property="og:url" content="https://betteraibots.com/news/${articleSlug}">
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://betteraibots.com/news/${articleSlug}"
      },
...
<body>
    <div class="container">
        ...
        <p>Read the full article at <a href="https://betteraibots.com/news/${articleSlug}" style="color: #00ff88;">BetterAiBots.com</a></p>
    </div>
</body>
</html>`;
  ...
  return {
    statusCode: 302,
    headers: {
      'Location': `https://betteraibots.com/news/${articleSlug}`
    },
    body: ''
  };
}; 